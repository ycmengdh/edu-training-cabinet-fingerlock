    ...
    internal static class UserManageDialogs
    {
        ...
        public static bool ShowPermissionDialog(Window? owner, out bool[] permissions)
        {
            ...
            var checks = new[]
            {
                ...
                new CheckBox { Content = "Lock 2  实训柜 1", IsChecked = permissions[1], Margin = new Thickness(0, 0, 0, 10) },
                new CheckBox { Content = "Lock 3  实训柜 2", IsChecked = permissions[2], Margin = new Thickness(0, 0, 0, 10) },
                new CheckBox { Content = "Lock 4  实训柜 3", IsChecked = permissions[3], Margin = new Thickness(0, 0, 0, 16) }
            };
            ...
            bool forceStudent = false)
        {
            ...
            var codeLabel = Label("学号");
            panel.Children.Add(codeLabel);
            var codeBox = new TextBox { Height = 34, Margin = new Thickness(0, 0, 0, 14) };
            ...
            {
                string selectedRole = (roleCombo.SelectedItem as ComboBoxItem)?.Tag?.ToString() ?? "student";
                bool visible = !forceStudent && selectedRole != "student";
                codeLabel.Text = selectedRole switch
                {
                    "student" => "学号",
                    "teacher" => "教师 ID",
                    _ => "账号 ID"
            ...
            bool forceStudent = false)
        {
            ...
            bool confirmed = false;
            string localUserCode = user.DisplayId;
        ...
        private static ComboBox BuildRoleCombo(bool forceStudent, string selectedRole)
        {
            ...
            roleCombo.Items.Add(new ComboBoxItem { Content = "教师 (teacher)", Tag = "teacher" });
            roleCombo.Items.Add(new ComboBoxItem { Content = "学生（无登录密码）", Tag = "student" });
