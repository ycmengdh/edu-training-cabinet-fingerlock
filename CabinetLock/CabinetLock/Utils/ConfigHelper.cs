...
namespace CabinetLock
{
    ...
    public class AppConfig
    {
        ...
        {
            var type = Enum.TryParse<global::CabinetLock.TransportType>(TransportType, true, out var t)
                ? t
                : global::CabinetLock.TransportType.UsbSerial;
            return new TransportConfig
            {
                ...
                Port = type == global::CabinetLock.TransportType.TcpServer ? TcpServerPort : TcpClientPort
            };
        }
    }
