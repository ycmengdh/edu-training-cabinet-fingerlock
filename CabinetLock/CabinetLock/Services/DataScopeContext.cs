    ...
    public class DataScopeContext : IDataScopeContext
    {
        ...
        public bool CanSee(User target)
        {
            ...
            if (IsTeacher)
            {
                ...
                {
                    return CurrentUser.IsResponsibleForClass(target.ClassId);
                }
                // 其他教师：不可见（数据范围隔离）
                return false;
            }
        ...
        public bool CanCreate(User target)
        {
            ...
            return string.Equals(target.Role, "student", StringComparison.OrdinalIgnoreCase) &&
                   CurrentUser.IsResponsibleForClass(target.ClassId);
        }
        ...
        public bool CanUpdate(User existing, User updated)
        {
            ...
            return IsTeacher &&
                   ...
                   CurrentUser?.IsResponsibleForClass(updated.ClassId) == true;
        }
        ...
        public List<string>? GetVisibleClassIds()
        {
            ...
            if (IsTeacher)
            {
                return CurrentUser?.GetResponsibleClassIds().ToList() ?? new List<string>();
            }
            // Student
