...
namespace FingerprintLockManager
{
    ...
    public partial class UserManagePage : Page
    {
        ...
        {
            if (!UserManageDialogs.ShowAddUserDialog(OwnerWindow, out string name, out string role,
        ...
        private async void DeleteUserButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var result = MessageBox.Show(
                $"确认删除用户「{selected.Name}（{selected.UserId}）」？\n该用户的权限记录将一并删除。",
        ...
        private async void EditUserButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!UserManageDialogs.ShowEditUserDialog(OwnerWindow, selected, out string name,
